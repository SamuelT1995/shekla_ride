...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (data.user.role === "AGENCY_OWNER") navigate("/agency/dashboard");
      ...
      <div className="hidden lg:flex w-1/3 bg-primary relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12 space-y-12">
          ...
          <p className="text-lg text-slate-400 font-medium leading-relaxed">
            Ethopia's premier gateway to exclusive vehicle ownership and travel
            experiences.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, role: "AGENCY_OWNER" })
                  }
                  className={`py-6 rounded-2xl font-bold uppercase tracking-[0.2em] text-[10px] transition-all border ${formData.role === "AGENCY_OWNER" ? "border-primary bg-primary text-secondary shadow-luxe" : "border-slate-100 bg-white text-slate-300 hover:border-slate-200"}`}
                >
                  Rental Agency
                </button>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-top-4 duration-700">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <input
                      name="agencyName"
                      className="w-full bg-white border border-slate-50 focus:border-primary/20 rounded-2xl py-5 px-8 outline-none transition-all font-medium text-sm"
              ...
              <div className="space-y-8">
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-xs text-slate-400 font-medium">
                    To maintain the integrity of our network, we require a scan
                    of your Credentials.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <FileUpload
                    ...
                    maxFiles={1}
                    onFileSelect={(files) =>
                      setFormData({ ...formData, licenseFront: files[0] })
                    }
                  ...
                  <FileUpload
                    ...
                    maxFiles={1}
                    onFileSelect={(files) =>
                      setFormData({ ...formData, licenseBack: files[0] })
                    }
              ...
              {formData.role === "AGENCY_OWNER" && (
                <div className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-xs text-slate-400 font-medium">
                      Please provide a valid trade license or legal business
                  ...
                  <FileUpload
                    ...
                    maxFiles={1}
                    onFileSelect={(files) =>
                      setFormData({ ...formData, businessLicense: files[0] })
                    }
                    helperText="PDF or Image of business license"
                  />
                </div>
              )}
              ...
              {formData.role === "OWNER" && (
                <div className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-xs text-slate-400 font-medium">
                      As a prospective Host, please provide a preview of your
                      flagship asset and proof of registry.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FileUpload
                      ...
                      maxFiles={5}
                      onFileSelect={(files) =>
                        setFormData({ ...formData, vehicleImages: files })
                      }
                    ...
                    <FileUpload
                      ...
                      maxFiles={1}
                      onFileSelect={(files) =>
                        setFormData({ ...formData, ownershipDocs: files[0] })
                      }
