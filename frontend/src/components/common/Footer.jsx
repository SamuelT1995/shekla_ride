        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-24 mb-32">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <p className="text-lg text-slate-400 font-medium leading-relaxed max-w-sm">
              ...
              Professional service for an extraordinary journey.
            </p>
        ...
        <div className="pt-12 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-300">
              ©{currentYear} Shekla Ride
            </span>
            <div className="flex gap-8">
              <Link
                to="/privacy"
                className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 hover:text-primary transition-colors"
              >
                Privacy
              </Link>
              <Link
